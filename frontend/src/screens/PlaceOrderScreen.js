...
const PlaceOrderScreen = ({ history }) => {
  ...
  cart.totalPrice = (Number(cart.itemsPrice) + Number(cart.feePrice)).toFixed(2)
            ...
            <ListGroup variant='flush'>
              ...
              <ListGroup.Item>
                <Row>
                  ...
                  <Row>
                    <Col md={8}>
                      <input onChange={e => setCoupon(e.target.value)} className='couponvalue' />
                    </Col>
                    <Col>
                      <Button type='button' className='btn-block' onClick={addCouponHandler}>
                        Add
                      </Button>
                    </Col>
                  </Row>
